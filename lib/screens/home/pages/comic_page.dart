...
class _ComicPageState extends State<ComicPage> {
  ...
  final _categories = ['全部', '热血', '冒险', '搞笑', '恋爱', '科幻', '悬疑'];
              ...
              return GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: sel ? const Color(0xFFFF9800) : Colors.grey[100],
              ...
              : _items.isEmpty
                  ? Center(child: Column(
                      ...
                      children: [
                        ...
                        Text('暂无漫画源', style: TextStyle(color: Colors.grey[400], fontSize: 15)),
                        const SizedBox(height: 6),
                        Text('请在「我的」→ 设置中添加', style: TextStyle(color: Colors.grey[400], fontSize: 12)),
                      ],
                    ))
                  : RefreshIndicator(
                      onRefresh: _loadData,
  ...
  Widget _buildCard(UnifiedContent item) {
    return GestureDetector(
      onTap: () => Navigator.push(context,
          MaterialPageRoute(builder: (_) => ComicDetailScreen(content: item))),
      child: Column(
